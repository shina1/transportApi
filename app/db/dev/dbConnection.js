 ...
 */
 ...
 const createUserTable = ()=>{
     const userQuery = `CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY,
 ...
 const createBusTable = () =>{
     const busQuery = `CREATE TABLE IF NOT EXISTS bus (id SERIAL PRIMARY KEY,
        number_plate VARCHAR(100) NOT NULL,
        manufaturer VARCHAR(100) NOT NULL,
        model VARCHAR(100) NOT NULL,
        year VARCHAR(10) NOT NULL,
        capacity integer NOT NULL,
        created_on DATE NOT NULL)`;

        pool.query(busQuery).then((res)=>{
            console.log(res);
            pool.end();
        }).catch((err)=>{
            console.log(err);
  ...
  */
  ...
  const createTripTable = () =>{
      const tripQuery = `CREATE TABLE IF NOT EXISTS trip (id SERIAL PRIMARY KEY,
